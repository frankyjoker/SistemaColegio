...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <hr>
      <form class="form-horizontal" action="registros.php?pagina=3" method="POST" name="form1"> 
    <!-- Text input-->
    <div class="form-group">
      <label class="col-md-4 control-label" for="nombre">Nombre</label>  
      <div class="col-md-4">
      <input id="nombre" name="nombre" type="text" placeholder="Ingrese un Nombre" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="apellido" name="apellido" type="text" placeholder="Ingrese un Apellido" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="cedula" name="cedula" type="text" placeholder="Cédula" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="puesto" name="puesto" type="text" placeholder="Posición o Puesto" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="fechaInicio" name="fechaInicio" type="date" placeholder="Fecha Inicio" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="sueldo" name="sueldo" type="text" placeholder="Sueldo" class="form-control input-md" required="">
