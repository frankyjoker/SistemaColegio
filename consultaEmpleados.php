...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 class="container-fluid text-center">Consulta Empleados</h1> </br>
				<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
					<b>Nombre o Apellido: </b><input type="text" id="campo" name="campo" />
					<input type="submit" id="enviar" name="enviar" value="Buscar" class="btn btn-info" />
				</form>  
        <div class="container-fluid text-right">
           <a href="registroEmpleados.php" class="btn btn-primary">Nuevo Registro</a>
        </div>
       </div>
      <div class="container-fluid text-left">
  ...
  <script>
    ...
    function obtenerDatos() {
      ...
      $.ajax({
        url: "obtenerTablaDeEmpleados.php",
        method: "POST",
        data: {
          campo: $("#campo").val()
        }
