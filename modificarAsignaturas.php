...
include("conexion.php");
	...
	$sql = "SELECT * FROM asignatura WHERE codigo = '$codigo'";
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 class="container-fluid text-center">Modificar Asignatura</h1> <br>
      <hr>
<fieldset>

  <form class="form-horizontal" action="registros.php?pagina=9" method="POST" name="form1"> 
  ...
  <input type="hidden" id="codigo" name="codigo" value="<?php echo $row["codigo"]; ?>" />
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="cantidad" name="cantidad" type="text" placeholder="Ingresar la cantidad" class="form-control input-md" value= <?php echo $row['cantidad']; ?> required="">
      </div>
    </div>
