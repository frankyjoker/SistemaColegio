...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 class="container-fluid text-center">Registro Aulas</h1>
      <hr>
      
<fieldset>

  <form class="form-horizontal" action="registros.php?pagina=10" method="POST" autocomplete="off" name="form1"> 
    <!-- Text input-->
    <div class="form-group">
      <label class="col-md-4 control-label" for="descripcion">Descripcion</label>  
      <div class="col-md-4">
      <input id="descripcion" name="descripcion" type="text" placeholder="Ingresar una Descripcion" class="form-control input-md" required=""> 
      </div>
    </div>
