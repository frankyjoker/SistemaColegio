...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 class="container-fluid text-center">Modificar Estudiante</h1> <br>
      <hr>
<fieldset>

  <form class="form-horizontal" action="registros.php?pagina=2" method="POST" name="form1"> 
  ...
  <input type="hidden" id="codigo" name="codigo" value="<?php echo $row["codigo"]; ?>" />
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="telefono" name="telefono" type="tel" placeholder="" class="form-control input-md" value= <?php echo $row['telefono']; ?>  required="" >
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="fechaNacimiento" name="fechaNacimiento" type="date" placeholder="" class="form-control input-md"  value= <?php echo $row['fechaNacimiento']; ?> required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="correoElectronico" name="correoElectronico" type="text" placeholder="Correo Electronico" class="form-control input-md" value= <?php echo $row['correoElectronico']; ?> required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="padre" name="padre" type="text" placeholder="Nombre" class="form-control input-md" value= <?php echo $row['padre']; ?> required="">
    ...
    <!-- Text input-->
    <div class="form-group">
      <label class="col-md-4 control-label" for="madre">Madre</label>  
      <div class="col-md-4">
      <input id="madre" name="madre" type="text" placeholder="Nombre" class="form-control input-md" value= <?php echo $row['madre']; ?> required="">
      </div>
    </div>
    <!-- Button -->
    <div class="form-group">
