...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 class="container-fluid text-center">Registro Asignaturas</h1>
      <hr>
      
<fieldset>

  <form class="form-horizontal" action="registros.php?pagina=8" method="POST" autocomplete="off" name="form1"> 
    <!-- Text input-->
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="cantidad" name="cantidad" type="text" placeholder="Ingresar la Cantidad" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        ...
        <a href="consultaAsignaturas.php" class="btn btn-primary">Regresar</a>
      </div>
    </div>
    </form>
    </fieldset>
