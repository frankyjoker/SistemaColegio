...
<fieldset>
  ...
  <form class="form-horizontal" action="registros.php?pagina=1" method="POST" autocomplete="off" name="form1"> 
    <!-- Text input-->
    <div class="form-group">
      <label class="col-md-4 control-label" for="nombre">Nombre</label>  
      <div class="col-md-4">
      <input id="nombre" name="nombre" type="text" placeholder="Ingresar un Nombre" class="form-control input-md" required=""> 
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="apellido" name="apellido" type="text" placeholder="Ingresar un Apellido" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="telefono" name="telefono" type="tel" placeholder="Telefono" class="form-control input-md">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="correoElectronico" name="correoElectronico" type="correoElectronico" placeholder="Correo Electronico" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="padre" name="padre" type="text" placeholder="Nombre y Apellido" class="form-control input-md" required="">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="madre" name="madre" type="text" placeholder="Nombre y Apellido" class="form-control input-md" required="">
      </div>
    </div>
    <!-- Button -->
    <div class="form-group">
